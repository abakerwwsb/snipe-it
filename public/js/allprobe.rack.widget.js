    ...
    $.widget("allprobe.rack", {
        ...
        divideData: function() {
            ...
            $.each(this.hosts, function(index, host) {
                ...
                host.pos = parseFloat(host.pos);
                
                if(host.pos === 0) {
                    that.zeroPosHosts.push(host);
                } else if( host.pos > 0 ) {
                    if(host.pos % 1 !=0){
                        console.log("host.pos % 1 !=1 | " + host.pos)
                    }
        ...
        combineSimilarRackUnit: function() {
            //const similarRackPos = this.hosts.filter(item => this.hosts.pos.indexOf(16.1) !== -1);
            console.log(this);
        },
                ...
                if(value) {
                    ...
                    for(var i = 0; i < value.size; i++) {
                        ...
                        if(i === 0 ) {
                            ...
                            that.indexArray[i] = "<div class='individual-server-first-child' style='height:" + (that.unitHeight - 1)+"px;"+ colorText +"'>" + ( that.running ) + "</div>";
                        }
        ...
        implementClick: function(div) {
            ...
            $(div).click(function(event) {
                ...
                document.getElementById('server-more-info').innerHTML = jsonContent.submenu;
            });
        }
